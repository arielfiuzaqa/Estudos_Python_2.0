# --- Projeto: Gerador e Automatizador de Jogos da Quina ---
...
ARQUIVO_TXT = os.path.join(PASTA_SALVAMENTO, "jogos_gerados_quina.txt")
...
# === Função 2: Gerar jogos usando apenas a estratégia equilibrada ===
...
def preencher_jogos_web(jogos):
    ...
    try:
        bot.get("https://loterias.caixa.gov.br/wps/portal/loterias/landing/quina/")
        time.sleep(5)
        ...
        for idx, jogo in enumerate(jogos, 1):
            ...
            novo_jogo_btn = bot.find_element(By.XPATH, "//button[contains(text(),'Quina')]")
            novo_jogo_btn.click()
            time.sleep(2)
